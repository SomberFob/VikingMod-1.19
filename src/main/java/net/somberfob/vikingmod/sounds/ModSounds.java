...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> VIKING_CHARGE =
            registerSoundEvent("viking_charge");

    public static final RegistryObject<SoundEvent> CAVE_DRUMS =
            registerSoundEvent("cave_drums");
